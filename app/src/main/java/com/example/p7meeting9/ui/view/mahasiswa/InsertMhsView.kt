...
import com.example.p7meeting9.ui.navigation.AlamatNavigasi
import com.example.p7meeting9.ui.viewmodel.FormErrorState
import com.example.p7meeting9.ui.viewmodel.MahasiswaEvent
import com.example.p7meeting9.ui.viewmodel.MahasiswaViewModel
import com.example.p7meeting9.ui.viewmodel.MhsUIState
...
fun InserMhstView(
    ...
    val uiState = viewModel.uiState // Ambill UI State dari ViewModel
    ...
    Scaffold(
        modifier = modifier,
        snackbarHost = { SnackbarHost(hostState = snackbarHostState) }// Tempatkan snackbar di scaff
    ){ padding ->
        Column (
            modifier = modifier
                .fillMaxSize()
...
fun FormMahasiswa(
    ...
    val kelas = listOf("A","B","C","D","E")
     ...
     Column(
         ...
         Text(
             text = errorState.nama ?: "", //digunakan untuk memunculkan pesan error
             color = Color.Red
         )
         ...
         OutlinedTextField(
             ...
             placeholder = { Text("Masukan Aalamat") },
